...
func TestConfigValidation(t *testing.T) {
	cases := map[string]string{
		...
		"bad endpoint":                 "load:\n  endpoint: expand\n",
		"empty endpoint mapping":       "load:\n  endpoint: {}\n",
		"bad probability":              "seed:\n  wildcard_probability: 1.5\n",
		"nan probability":              "seed:\n  wildcard_probability: .nan\n",
		"inf contextual probability":   "contextual:\n  attach_probability: .inf\n",
		"bad allowed_ratio":            "probe:\n  allowed_ratio: 2\n",
		"nan allowed_ratio":            "probe:\n  allowed_ratio: .nan\n",
		"inf max_duplication":          "probe:\n  max_duplication: .inf\n",
		"bad fanout key":               "seed:\n  fanout:\n    notarelation: 3\n",
		"bad target key":               "probe:\n  targets: [document]\n",
		"zero target weight":           "probe:\n  targets:\n    - relation: document#viewer\n      weight: 0\n",
		"nan target weight":            "probe:\n  targets:\n    - relation: document#viewer\n      weight: .nan\n",
		"bad contextual key":           "contextual:\n  relations: [viewer]\n",
		"missing pool":                 "conditions:\n  has_scope:\n    params:\n      scopes: {pool: nope}\n",
		"nan endpoint weight":          "load:\n  endpoint:\n    check: .nan\n",
		"inf endpoint weight":          "load:\n  endpoint:\n    check: .inf\n",
		"negative rate":                "load:\n  rate: -5\n",
		"too high rate":                "load:\n  rate: 1000000001\n",
		"too high write rate":          "load:\n  write_rate: 1000000001\n",
		...
		"negative report interval":     "load:\n  report_interval: -1s\n",
		"negative sweep duration":      "load:\n  sweep:\n    rates: [100]\n    step_duration: -1s\n",
		"zero sweep duration":          "load:\n  sweep:\n    rates: [100]\n    step_duration: 0s\n",
		"too high sweep rate":          "load:\n  sweep:\n    rates: [1000000001]\n    step_duration: 1s\n",
		"sweep report interval":        "load:\n  report_interval: 10s\n  sweep:\n    rates: [100]\n    step_duration: 30s\n",
		...
		"nan distribution weight":      "conditions:\n  has_scope:\n    params:\n      granted_scopes: {keys_distribution: {values: [2, 8], weights: [.nan, 1]}}\n",
		"inf distribution weight":      "conditions:\n  has_scope:\n    params:\n      granted_scopes: {keys_distribution: {values: [2, 8], weights: [.inf, 1]}}\n",
